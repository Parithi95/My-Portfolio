  ...
  return (
    <>
      <section
        ...
        id="home"
      >
        <div className="container md:flex  justify-between items-start mx-auto w-screen min-h-screen min-w-max ">
          <div className=" grow mt-20 md:self-stretch flex md:justify-around md:max-w-full md:min-h-fit">
            <div
              className=" grow md:my-20 mx-5 md:py-10 px-5 rounded-tr-full rounded-tl-full rounded-br-full md:flex justify-center items-center min-w-72 hidden md:visible bg-center md:bg-cover"
              style={{
                backgroundImage:
            ...
            ></div>
            <div
              className="grow my-20 mx-5 py-10 px-5 rounded-br-full rounded-bl-full rounded-tl-full flex justify-center items-center  md:min-w-72 bg-center md:bg-cover"
              style={{
                backgroundImage:
